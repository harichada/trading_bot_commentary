...
Usage:
    python -m backtest.cli stage-a --lane mean_reversion --direction LONG
    python -m backtest.cli stage-a --lane day_trade_momentum --direction SHORT
    python -m backtest.cli stage-a --all
    python -m backtest.cli scorecard --output research/reports/
...
def write_markdown_scorecard(scorecard: Dict, output_path: Path):
    ...
    lines.extend([
        ...
        "---",
        "",
        "*Scorecard generated by `python -m backtest.cli scorecard`*",
        ""
    ])
